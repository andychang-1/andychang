    ...
    return (
        <div>
            ...
            <div className="grid-container">
                <div className="grid-item">SELECTED GROUP EXHIBITIONS</div>
                <div className="grid-item" />
                <div className="grid-item">✧ 2025</div>
                <div className="grid-item">
                ...
                <div className="grid-item">
                    ...
                    <div className="grid-item">
                        <div className="grid-item">✧ 2023</div>
                        <div className="grid-item">
                        ...
                        <div className="grid-item" />
                        <div className="grid-item">✧ 2022</div>
                        <div className="grid-item">
                            <i>The Other Art Fair</i>, Agger Fish Building, Brooklyn, NY
                        </div>
                        <div className="grid-item" />
                        <div className="grid-item">SVA Flatiron Gallery, New York, NY</div>
                        <div className="grid-item" />
                        <div className="grid-item">
                            <i>The House Down Project</i>, Rogue Space Gallery, New York, NY
                        </div>
                        <div className="grid-item" />
                        <div className="grid-item">✧ 2021</div>
                        <div className="grid-item">
                        ...
                        <div className="grid-item" />
                        <div className="grid-item">✧ 2019</div>
                        <div className="grid-item">
                        ...
                        <div className="grid-item" />
                        <p />
                        <div className="grid-item">RESIDENCIES</div>
                        <div className="grid-item" />
                        <div className="grid-item">✧ 2023</div>
                        <div className="grid-item">Kunstraum Artist Residency, Brooklyn, NY</div>
                        <div className="grid-item" />
                        <div className="grid-item">
                        ...
                        <div className="grid-item" />
                        <p />
                        <div className="grid-item">TEACHING</div>
                        <div className="grid-item" />
                        <div className="grid-item">✧ 2022</div>
                        <div className="grid-item">
                        ...
                        <p />
                        <p />
                        <div className="grid-item">HONORS</div>
                        <div className="grid-item" />
                        <div className="grid-item">✧ 2021</div>
                        <div className="grid-item">Honors, Tang Museum Exhibition</div>
                        <div className="grid-item">
                            Fiction Writing Honors, Skidmore College
                        </div>
                        <div className="grid-item" />
                        <div className="grid-item">✧ 2020</div>
                        <div className="grid-item">
                        ...
                        <div className="grid-item">✧ 2021</div>
                        <div className="grid-item">
                            B.S Studio Arts &amp; B.A English, <i>cum laude</i>, Skidmore College. Saratoga Springs, NY
                            <div className="grid-item" />
                            <div className="grid-item">✧ 2019</div>
                            <div className="grid-item">
